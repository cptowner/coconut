...
class SeatsControllerTest < ActionController::TestCase
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post :create, seat: { baggage: @seat.baggage, flight_id: @seat.flight_id, name: @seat.name, string: @seat.string }
    end
  ...
  test "should update seat" do
    put :update, id: @seat, seat: { baggage: @seat.baggage, flight_id: @seat.flight_id, name: @seat.name, string: @seat.string }
    assert_redirected_to seat_path(assigns(:seat))
  end
